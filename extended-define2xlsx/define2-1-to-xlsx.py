...
import dictionaries, methods, rules, comments, documents

WORKSHEETS = ["Study", "Standards", "Datasets", "Variables", "ValueLevel", "WhereClauses", "CodeLists", "Dictionaries",
              "Methods", "Rules", "Comments", "Documents"]
EXCEL_NAME = "extended-define.xlsx"
...
EXTRACTORS = {
    ...
    "Rules": lambda s, m, p, l, a: rules.Rules(m, p),
...
class Define2Xls:
    ...
    def create(self):
        loader = LD.ODMLoader(OL.XMLDefineLoader(model_package="exdefine_2_1", ns_uri="http://www.nurocor.com/ns/MDR-XML/v1.0", local_model=True))
