...
class Methods:
    HEADERS = ["OID", "Name", "Type", "Description", "Expression Context", "Expression Code", "Document", "Pages", "Rule"]
    ...
    def extract(self):
        with open(self.file_name, 'w', newline='') as f:
            ...
            for md in self.mdv.MethodDef:
                ...
                rule_ref = md.RuleRef.RuleOID if md.RuleRef else ""
                writer.writerow([md.OID, md.Name, md.Type, description, context, code,
                                 leaf_id, page_refs, rule_ref])
